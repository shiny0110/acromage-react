...
This non-profit fan-remake of the tower defense, resource management fantasy game is developed by [@sunny](https://github.com/sunnyDev93) with TypeScript + React + Redux + redux-observable + RxJS + CSS-based animations + WebRTC (see [§ Development](#development)). Please star the repo / follow me to support me.
...
- [Cards](https://github.com/arcomage/arcomage-hd/tree/main/src/i18n/cards): extracted from _Might and Magic VIII_ & _VI_ original games (or translated/retranslated) by:
  ...
  - Simplified Chinese (`zh-Hans`): (extracted) [Liar-zzy](https://github.com/Liar-zzy/Arcomage/blob/master/Arcomage.cpp), (fixed/retranslated) [Sunny](https://github.com/sunnyDev93)
  ...
  - Japanese (`ja`) (translated): [Sunny](https://github.com/sunnyDev93) with the help of [Google Translate](https://translate.google.com/) & [DeepL](https://www.deepl.com/translator)
  - Ukrainian (`uk`) (translated): [troyane](https://github.com/troyane)
  - All others: [Sunny](https://github.com/sunnyDev93) with OCR tool [tesseract.js](https://tesseract.projectnaptha.com/) & [other scripts](https://github.com/arcomage/arcomage-hd/tree/main/tools)
  - Traditional Chinese (`zh-Hant`): converted from `zh-Hans` by [Sunny](https://github.com/sunnyDev93) with [his scripts](https://github.com/arcomage/arcomage-hd/tree/main/tools/zhconvert) using [opencc-js](https://github.com/nk2028/opencc-js)
- [Main](https://github.com/arcomage/arcomage-hd/tree/main/src/i18n/main) string translators (some are from the original games):
  ...
  - All others: [Sunny](https://github.com/sunnyDev93) by himself and/or with the help of [Google Translate](https://translate.google.com/) & [DeepL](https://www.deepl.com/translator)
  - Traditional Chinese (`zh-Hant`): converted from `zh-Hans` by [Sunny](https://github.com/sunnyDev93) with [his scripts](https://github.com/arcomage/arcomage-hd/tree/main/tools/zhconvert) using [opencc-js](https://github.com/nk2028/opencc-js)
- [Taverns](https://github.com/arcomage/arcomage-hd/tree/main/src/i18n/taverns): extracted from _Might and Magic VIII_ & _VI_ original games by [Sunny](https://github.com/sunnyDev93) with [his script](https://github.com/arcomage/arcomage-hd/tree/main/tools/i18n-extraction). Except for:
  - Brazilian Portuguese (`pt-BR`) (translated): [mateuscv](https://github.com/mateuscv)
  - Japanese (`ja`) (translated): [Sunny](https://github.com/sunnyDev93) with the help of [Google Translate](https://translate.google.com/) & [DeepL](https://www.deepl.com/translator)
  - Ukrainian (`uk`) (translated): [troyane](https://github.com/troyane)
...
The code of the ArcoMage HD game: MIT License (c) 2021 [Shiny](https://github.com/shiny0110).
